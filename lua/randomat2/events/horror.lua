...
local musicConvar = CreateConVar("randomat_horror_music", 1, FCVAR_NONE, "Play music during this randomat", 0, 1)
local endingCvar = CreateConVar("randomat_horror_ending", 1, FCVAR_NONE, "Win screen plays a horror sound and ending title is changed", 0, 1)
local specSoundsCvar = CreateConVar("randomat_horror_spectator_sounds", 1, FCVAR_NONE, "Spectators can play horror sounds", 0, 1)
local cloakSoundsCvar = CreateConVar("randomat_horror_cloak_sounds", 1, FCVAR_NONE, "Sounds play as the killer is cloaked/uncloaks", 0, 1)
local chargeTimeCvar = CreateConVar("randomat_horror_spectator_charge_time", 30, FCVAR_NONE, "Seconds until a spectator can play a sound again", 10, 120)
local soundCooldownCvar = CreateConVar("randomat_horror_spectator_sound_cooldown", 30, FCVAR_NONE, "Seconds until someone can hear a spectator sound again", 10, 120)
local crowbarCvar = CreateConVar("randomat_horror_killer_crowbar", 0, FCVAR_NONE, "Killer gets a throwable crowbar rather than a normal one", 0, 1)
local healthCvar = CreateConVar("randomat_horror_killer_starting_health", 150, FCVAR_NONE, "How much health the killer starts with", 1, 500)
local creditsCvar = CreateConVar("randomat_horror_killer_credits", 1, FCVAR_NONE, "Credits the killer starts with", 0, 5)
local cloakCvar = CreateConVar("randomat_horror_killer_cloak", 1, FCVAR_NONE, "Killer gets a 'Shadow Cloak' item. Makes them appear as a shadow while held", 0, 1)
CreateConVar("randomat_horror_cloak_sound_timer", 10, FCVAR_NONE, "Seconds until the cloak sound is heard again while cloaked", 5, 60)
