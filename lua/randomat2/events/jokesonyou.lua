...
CreateConVar("randomat_jokesonyou_health", 100, {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The health that the Jesters respawn with", 1, 200)

CreateConVar("randomat_jokesonyou_include_dead", 1, {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "Whether to resurrect dead players at the start")
