local EVENT = {}
CreateConVar("randomat_paranoia_spectator_charge_time", 30, FCVAR_NONE, "Seconds until a spectator can play a sound again", 10, 120)
CreateConVar("randomat_paranoia_spectator_sound_cooldown", 30, FCVAR_NONE, "Seconds until someone can hear a spectator sound again", 10, 120)
