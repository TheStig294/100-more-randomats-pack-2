...
EVENT.Description = "Places shark traps around the map"
EVENT.id = "sharktrap"
EVENT.SingleUse = false

EVENT.Categories = {"entityspawn", "largeimpact"}

CreateConVar("randomat_sharktrap_chance", 20, {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "% of possible spawns replaced with shark traps", 1, 100)
